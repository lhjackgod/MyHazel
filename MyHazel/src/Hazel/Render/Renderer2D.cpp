...
namespace Hazel {
	...
	struct Renderer2DDate
	{
		...
		uint32_t TextureSlotIndex = 1;//0 for white
...
void Hazel::Renderer2D::ResetStats()
{
	memset(&s_Data.Stats, 0, sizeof(Statistics));
}

Hazel::Renderer2D::Statistics Hazel::Renderer2D::GetStats()
{
	return s_Data.Stats;
}

void Hazel::Renderer2D::FlushAndReset()
{
	EndScene();
	s_Data.QuadVertexBufferPtr = s_Data.QuadVertexBufferBase;
	s_Data.TextureSlotIndex = 1;
